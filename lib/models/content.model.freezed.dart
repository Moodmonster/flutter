...
mixin _$Content {
 ...
 String get code; String get title; String get desc; String get author; String get userId; MyContentType get contentType;//웹툰인지 소설인지
...
@useResult
$Res call({
 String code, String title, String desc, String author, String userId, MyContentType contentType, int clickCount, String thumbnailUrl
});
