...
@JsonKey(name: 'episodeCode') String get code; String get contentCode;//해당 에피소드가 속해있는 웹툰의 고유 코드
 String get epTitle; DateTime get uploadDate;//업로드된 날짜
 String get thumbnailUrl; String get ttsUrl;
...
@useResult
$Res call({
@JsonKey(name: 'episodeCode') String code, String contentCode, String epTitle, DateTime uploadDate, String thumbnailUrl, String ttsUrl
});
...
/// Create a copy of ContentEpisode
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? code = null,Object? contentCode = null,Object? epTitle = null,Object? uploadDate = null,Object? thumbnailUrl = null,Object? ttsUrl = null,}) {
...
as String,ttsUrl: null == ttsUrl ? _self.ttsUrl : ttsUrl // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
class _ContentEpisode implements ContentEpisode {
   _ContentEpisode({@JsonKey(name: 'episodeCode') this.code = "", required this.contentCode, required this.epTitle, required this.uploadDate, this.thumbnailUrl = "", this.ttsUrl = ""});
  factory _ContentEpisode.fromJson(Map<String, dynamic> json) => _$ContentEpisodeFromJson(json);

@override@JsonKey(name: 'episodeCode') final  String code;
...
@override@JsonKey() final  String ttsUrl;
...
/// Create a copy of ContentEpisode
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? code = null,Object? contentCode = null,Object? epTitle = null,Object? uploadDate = null,Object? thumbnailUrl = null,Object? ttsUrl = null,}) {
